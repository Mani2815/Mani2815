...
def generate_svg(days, total, theme_name):
    ...
    svg = [
        ...
        f'<text x="40" y="40" fill="{theme["text"]}" font-family="sans-serif" font-weight="bold" font-size="18">Contribution Calendar</text>',
        f'<text x="40" y="70" fill="{theme["text"]}" font-family="sans-serif" font-size="14">Total: {total:,}</text>',
        f'<text x="40" y="90" fill="{theme["text"]}" font-family="sans-serif" font-size="14">Current streak: {current:,} days</text>',
        f'<text x="40" y="110" fill="{theme["text"]}" font-family="sans-serif" font-size="14">Longest streak: {longest:,} days</text>',
        f'<text x="40" y="130" fill="{theme["text"]}" font-family="sans-serif" font-size="14">Highest day: {max_day:,}</text>',
        f'<text x="40" y="150" fill="{theme["text"]}" font-family="sans-serif" font-size="14">Average: {avg:.2f}/day</text>',
        '<g>'
    ]
