def generate_test():
    ...
    blue = "#0969da"
    gray = "#8b949e"
    # test writing out the new SVG text block
    svg = [
        '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 960 600" width="960" height="600">',
        '<rect width="960" height="600" fill="transparent" rx="10"/>',
        # Calendar Icon + Title
        ...
        f'<text x="30" y="13" fill="{gray}" font-family="sans-serif" font-size="15">Current streak 5 days</text>',
        f'</g>',
        ...
        f'<text x="30" y="13" fill="{gray}" font-family="sans-serif" font-size="15">Best streak 26 days</text>',
        f'</g>',
        f'</g>',
        ...
        f'<text x="30" y="13" fill="{gray}" font-family="sans-serif" font-size="15">Highest in a day at 20</text>',
        f'</g>',
        ...
        f'<text x="30" y="13" fill="{gray}" font-family="sans-serif" font-size="15">Average per day at ~0.76</text>',
        f'</g>',
        f'</g>',
        '</svg>'
    ]
    with open("assets/test_layout.svg", "w") as f:
        f.write("\n".join(svg))
generate_test()
